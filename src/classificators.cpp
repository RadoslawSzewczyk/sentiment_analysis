...
std::pair<int, double> naiveBayes::predict(std::vector<int> features){
...
void naiveBayes::saveToFile(const std::string& filename) const{
...
void naiveBayes::readFromFile(const std::string& filename){
...
int naiveBayes::total_class_count(){
    int sum = 0;
        for (const auto& class_count : class_counts) {
